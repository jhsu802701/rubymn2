...
gem 'minitest-reporters', '1.3.8', require: false, group: :testing # Adds special features to tests
...
group :test, :development do
  gem 'faker', '2.10.0' # Generates fake data used for seeding the database
